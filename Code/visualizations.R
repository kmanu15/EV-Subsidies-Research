...
Census_IncomeF <- read.csv("Data Sets/Cleaned Data Sets/Census_IncomeF.csv")
...
## --------------------------------------------------------------------------------------------------------------------
WA_EV_data <- read.csv("Data Sets/Cleaned Data Sets/WA_EV_data.csv")
...
WA_FIPS <- read.csv("Data Sets/Cleaned Data Sets/WA_FIPS.csv")
...
# Saving the image
ggsave("Maps/EV_map.png", plot = EV_map)
...
# Saving Image
ggsave("Maps/Income_map.png", plot = Income_map)


## --------------------------------------------------------------------------------------------------------------------
county_code <- read.csv("Data Sets/Cleaned Data Sets/geographic_codes.csv") 
county_code <- county_code[, 1:2]

EV_Ratio <- read.csv("Data Sets/Cleaned Data Sets/kojo_data3.csv")
...
ggsave("Maps/EVRatio_map.png", plot = EVRatio_map)
